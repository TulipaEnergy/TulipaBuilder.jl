...
The interface is **heavily** tied to [TulipaEnergyModel's input schema](https://tulipaenergy.github.io/TulipaEnergyModel.jl/stable/20-user-guide/50-schemas/#table-schemas), but it glosses over the complexity.
