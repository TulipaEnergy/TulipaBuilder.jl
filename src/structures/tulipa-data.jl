...
"""
    add_or_update_year!(tulipa, year; kwargs...)
...
"""
    add_asset!(tulipa, asset::TulipaAsset)
...
"""
    add_asset!(tulipa, asset_name, type; kwargs...)
...
"""
    attach_commission_data!(tulipa, asset_name, year; kwargs...)
...
"""
    attach_milestone_data!(tulipa, asset_name, year; kwargs...)
...
"""
    attach_both_yeards_data!(tulipa, asset_name, commission_year,
...
"""
    add_flow!(tulipa, flow::TulipaFlow)
...
"""
    add_flow!(tulipa, from_asset_name, to_asset_name; kwargs...)
...
"""
    attach_commission_data!(tulipa, from_asset_name, to_asset_name, year; kwargs...)
...
"""
    attach_milestone_data!(tulipa, from_asset_name, to_asset_name, year; kwargs...)
...
"""
    attach_both_years_data!(tulipa, from_asset_name, to_asset_name,
...
"""
    attach_profile!(tulipa, asset_name, profile_type, year, profile_value)
